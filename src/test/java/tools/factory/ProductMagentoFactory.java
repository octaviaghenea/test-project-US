...
public class ProductMagentoFactory {
	...
	public static Product getMagentoProductInstance() {
	...
	public List<String> getWebsiteIDInstance() {
		List<String> websiteIDs= new ArrayList<String>();
		websiteIDs.add("1");
		return websiteIDs;		
	}
	
	public StockItem getstockInstance() {
		
		StockItem stock = new StockItem();
		
		stock.setProduct_id("Test01");
		stock.setStock_id("1");
		stock.setQty("9999");
	...
	public List<Options> getOptionsInstance() {
		
		List<Options> productOptions = new ArrayList<Options>();
		...
		productOptions.add(firstOption);
		...
		productOptions.add(secondOption);
		...
		productOptions.add(thirdOptionPoem);
